En prenant exemple sur le style des composants, crée les composants de visualisation des cours.

La structure de ces composants est définie dans src/components/course.

Utilise la librairie "react-markdown", "remark-math" et "remark-katex" pour render le markdown et les maths.

Voici le README complet de react-markdown
...
Crée également des custom components stylistiquement cohérent avec le reste de l'application.
